...
import org.m1theo.tinkerforge.client.devices.industrialquadrelay.ChannelId;
...
import org.m1theo.tinkerforge.client.devices.industrialquadrelay.Relay0Channel;
import org.m1theo.tinkerforge.client.devices.industrialquadrelay.Relay1Channel;
import org.m1theo.tinkerforge.client.devices.industrialquadrelay.Relay2Channel;
import org.m1theo.tinkerforge.client.devices.industrialquadrelay.Relay3Channel;
...
/**
 * The {@link IndustrialQuadRelayBrickletHandler} is responsible for handling
            ...
            if (bridgeStatus == ThingStatus.ONLINE) {
                ...
                if (deviceIn != null) {
                    if (deviceIn.getDeviceType() == DeviceType.industrialquadrelay) {
                        IndustrialQuadRelayBricklet device = (IndustrialQuadRelayBricklet) deviceIn;
