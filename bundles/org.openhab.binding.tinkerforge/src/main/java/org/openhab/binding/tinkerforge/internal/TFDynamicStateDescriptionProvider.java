...
/**
 * Dynamic channel state description provider. Overrides the state description
 * for the controls, which receive its configuration in the runtime.
 *
 * @author Theo Weiss <theo@m1theo.org> - Initial contribution
 */
@NonNullByDefault
@Component(service = { DynamicStateDescriptionProvider.class, TFDynamicStateDescriptionProvider.class })
