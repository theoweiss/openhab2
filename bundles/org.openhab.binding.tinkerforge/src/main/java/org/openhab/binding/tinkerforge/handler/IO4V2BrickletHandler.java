...
import org.m1theo.tinkerforge.client.devices.io4v2.ChannelId;
import org.m1theo.tinkerforge.client.devices.io4v2.Gpio0Channel;
import org.m1theo.tinkerforge.client.devices.io4v2.Gpio1Channel;
import org.m1theo.tinkerforge.client.devices.io4v2.Gpio2Channel;
import org.m1theo.tinkerforge.client.devices.io4v2.Gpio3Channel;
import org.m1theo.tinkerforge.client.devices.io4v2.GpioChannelConfig;
import org.m1theo.tinkerforge.client.devices.io4v2.IO4V2Bricklet;
import org.m1theo.tinkerforge.client.devices.io4v2.IO4V2DeviceConfig;
...
/**
 * The {@link IO4V2BrickletHandler} is responsible for handling commands, which are
...
public class IO4V2BrickletHandler extends BaseThingHandler implements CallbackListener, DeviceAdminListener {

    private final Logger logger = LoggerFactory.getLogger(IO4V2BrickletHandler.class);
    private @Nullable IO4V2DeviceConfig config;
    private @Nullable BrickdBridgeHandler bridgeHandler;
    private @Nullable IO4V2Bricklet device;
    ...
    public IO4V2BrickletHandler(Thing thing, TFDynamicStateDescriptionProvider dynamicStateDescriptionProvider) {
        super(thing);
    ...
    public void initialize() {
        config = getConfigAs(IO4V2DeviceConfig.class);
    ...
    private void enable() {
        ...
        if (brickdBridgeHandler != null) {
            ...
            if (bridgeStatus == ThingStatus.ONLINE) {
                ...
                if (deviceIn != null) {
                    if (deviceIn.getDeviceType() == DeviceType.io4v2) {
                        IO4V2Bricklet device = (IO4V2Bricklet) deviceIn;
    ...
    private void getgpio0() {
        ...
        if (brickdBridgeHandler != null) {
            ...
            if (device != null) {
                IO4V2Bricklet device2 = (IO4V2Bricklet) device;
