...
public class IndustrialDualAnalogInV2BrickletHandler extends BaseThingHandler implements CallbackListener, DeviceAdminListener {
        ...
        if (configUid != null) {
            ...
            if (brickdBridgeHandler != null) {
                ...
                if (bridgeStatus == ThingStatus.ONLINE) {
                    ...
                    if (device != null) {
                      if (device.getDeviceType() == DeviceType.industrialdualanalogInV2){
