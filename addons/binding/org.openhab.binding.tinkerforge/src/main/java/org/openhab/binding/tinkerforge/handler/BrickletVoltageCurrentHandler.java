...
/**
 * The {@link BrickletVoltageCurrentHandler} is responsible for handling commands, which are
...
public class BrickletVoltageCurrentHandler extends BaseThingHandler implements CallbackListener {

    private final Logger logger = LoggerFactory.getLogger(BrickletVoltageCurrentHandler.class);
    private @Nullable BaseDeviceConfig config;
    private @Nullable BrickdBridgeHandler bridgeHandler;
    private @Nullable String uid;

    public BrickletVoltageCurrentHandler(Thing thing) {
        super(thing);
    }
