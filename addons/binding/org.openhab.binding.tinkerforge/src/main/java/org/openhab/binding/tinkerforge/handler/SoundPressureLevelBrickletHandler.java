...
public class SoundPressureLevelBrickletHandler extends BaseThingHandler implements CallbackListener, DeviceAdminListener {
        ...
        if (notifier.getExternalDeviceId() != null) {
            ...
            if (notifier.getChannelId().equals(ChannelId.decibel.name())) {
                ...
                if (newValue instanceof DecimalValue) {
                    ...
                    updateState(notifier.getChannelId(), new QuantityType<>(new DecimalType(((DecimalValue) newValue).bigDecimalValue()), SmartHomeUnits.DECIBEL));
