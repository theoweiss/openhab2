...
import org.m1theo.tinkerforge.client.devices.oled128x64.ChannelId;
import org.m1theo.tinkerforge.client.devices.oled128x64.DisplayChannel;
import org.m1theo.tinkerforge.client.devices.oled128x64.OLED128x64Bricklet;
import org.m1theo.tinkerforge.client.devices.oled128x64.OLED128x64Config;
...
/**
 * The {@link OLED128x64BrickletHandler} is responsible for handling commands, which are
...
public class OLED128x64BrickletHandler extends BaseThingHandler implements DeviceAdminListener {

    private final Logger logger = LoggerFactory.getLogger(OLED128x64BrickletHandler.class);
    private @Nullable OLED128x64Config config;
    private @Nullable BrickdBridgeHandler bridgeHandler;
    private @Nullable OLED128x64Bricklet device;
    private @Nullable String uid;
    private boolean enabled = false;

    public OLED128x64BrickletHandler(Thing thing) {
        super(thing);
    }
    ...
    public void initialize() {
        config = getConfigAs(OLED128x64Config.class);
    ...
    private void enable() {
        ...
        if (brickdBridgeHandler != null) {
            ...
            if (bridgeStatus == ThingStatus.ONLINE) {
                ...
                if (deviceIn != null) {
                    if (deviceIn.getDeviceType() == DeviceType.oled128x64) {
                        OLED128x64Bricklet device = (OLED128x64Bricklet) deviceIn;
    ...
    private void getdisplay() {
        ...
        if (brickdBridgeHandler != null) {
            ...
            if (device != null) {
                OLED128x64Bricklet device2 = (OLED128x64Bricklet) device;
