...
import org.m1theo.tinkerforge.client.devices.ptc.ChannelId;
...
/**
 * The {@link PTCBrickletHandler} is responsible for handling commands, which are
...
public class PTCBrickletHandler extends BaseThingHandler implements CallbackListener, DeviceAdminListener {

    private final Logger logger = LoggerFactory.getLogger(PTCBrickletHandler.class);
    private @Nullable PTCDeviceConfig config;
    private @Nullable BrickdBridgeHandler bridgeHandler;
    private @Nullable PTCBricklet device;
    private @Nullable String uid;
    private boolean enabled = false;

    public PTCBrickletHandler(Thing thing) {
        super(thing);
    }
    ...
    public void initialize() {
        config = getConfigAs(PTCDeviceConfig.class);
    ...
    private void gettemperature() {
        ...
        if (brickdBridgeHandler != null) {
            ...
            if (device != null) {
                PTCBricklet device2 = (PTCBricklet) device;
