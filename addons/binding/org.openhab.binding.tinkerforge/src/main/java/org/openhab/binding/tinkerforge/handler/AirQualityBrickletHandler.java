        ...
        if (bridgeStatus == ThingStatus.ONLINE) {
            ...
            if (deviceIn != null) {
              if (deviceIn.getDeviceType() == DeviceType.airquality){
                device = (AirQualityBricklet) deviceIn;
    ...
    private void getiaqIndex() {
        ...
        if (brickdBridgeHandler != null) {
            ...
            if (device != null) {
                ...
                if (newValue instanceof DecimalValue) {
                    logger.debug("new value {}", newValue);
                    updateState(ChannelId.iaqIndex.name(), new DecimalType(((DecimalValue) newValue).bigDecimalValue()));
                    return;
                }
    ...
    private void getiaqAccuracy() {
        ...
        if (brickdBridgeHandler != null) {
            ...
            if (device != null) {
                ...
                if (newValue instanceof DecimalValue) {
                    logger.debug("new value {}", newValue);
                    updateState(ChannelId.iaqAccuracy.name(), new DecimalType(((DecimalValue) newValue).bigDecimalValue()));
                    return;
                }
